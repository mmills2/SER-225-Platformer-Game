...
public class CommonTileset extends Tileset {
    ...
    public ArrayList<MapTileBuilder> defineTiles() {
        ...
        // small cloud
        Frame cloudFrame = new FrameBuilder(getSubImage(3, 3), 0)
                .withScale(tileScale)
                .build();
        ...
        // left half cloud
        Frame leftCloudFrame = new FrameBuilder(getSubImage(3, 4), 0)
                .withScale(tileScale)
                .build();
        ...
        // right half cloud
        Frame rightCloudFrame = new FrameBuilder(getSubImage(3, 5), 0)
                .withScale(tileScale)
                .build();
        ...
        // cave background
        Frame caveFrame = new FrameBuilder(getSubImage(4, 0), 0)
                .withScale(tileScale)
                .build();

        MapTileBuilder caveTile = new MapTileBuilder(caveFrame);

        mapTiles.add(caveTile);

        // cave yellow flower
        Frame[] caveYellowFlowerFrames = new Frame[] {
        ...
        MapTileBuilder caveYellowFlowerTile = new MapTileBuilder(caveYellowFlowerFrames);

        mapTiles.add(caveYellowFlowerTile);

        // cave purple flower
        Frame[] cavePurpleFlowerFrames = new Frame[] {
        ...
        MapTileBuilder cavePurpleFlowerTile = new MapTileBuilder(cavePurpleFlowerFrames);
